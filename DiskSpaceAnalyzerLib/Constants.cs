...
namespace DiskSpaceAnalyzerLib
{
    public static class Constants
    {
        ...
        public static readonly string[] EBookExtensions =
        [
            "CBR", "EPUB", "FB2", "LIT", "LRF", "MOBI", "TCR", "PRC", "AZW3", "AZW", "ACSM", "OPF", "MBP", "CBZ", "APNX",
            "CBT", "VBK", "IBOOKS", "KFX"
        ];
        public static readonly string[] CadExtensions = ["DXF", "DWG", "3DM", "3DS", "MAX", "OBJ", "STP"];
        public static readonly string[] PresentationExtensions = ["ODP", "PPT", "PPTX", "PPS", "PPSX", "PPTM", "KEY", "FLIPCHART"];
        public static readonly string[] SpreadsheetExtensions =
        [
            "ODS", "XLS", "XLSX", "CSV", "WKS", "XLSM", "XLSB", "XLR", "WK3", "NUMBERS"
        ];
        public static readonly string[] DatabaseExtensions =
        [
        ...
        public static readonly string[] SystemExtensions =
        [
        ...
        public static readonly string[] ExecutablesExtensions =
        [
            "SCR", "EXE", "IPA", "APP", "BAT", "PS1", "CGI", "COM", "GADGET", "PIF", "VB", "WSF", "CMD", "DS", "AIR"
        ];
        public static readonly string[] SettingsExtensions =
        [
